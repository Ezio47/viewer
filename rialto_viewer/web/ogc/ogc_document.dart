...
class OgcDocument {
  ...
  String type;
  Map<String, _ParseElementFunction> elementsMap =
      new Map<String, _ParseElementFunction>();
  Map<String, _ParseAttributeFunction> attributesMap =
      new Map<String, _ParseAttributeFunction>();
...
class OgcCapabilitiesDocument_7 extends OgcDocument {
  ...
  OgcCapabilitiesDocument_7(Xml.XmlElement element) : super(element) {
    ...
    _registerElements({
      ...
      "ProcessOfferings":
          (e) => processOfferings = new OgcProcessOfferings_8(e),
...
class OgcProcessDescriptions_15 extends OgcDocument {
  List<OgcProcessDescription_16> descriptions =
      new List<OgcProcessDescription_16>();

  OgcProcessDescriptions_15(Xml.XmlElement element) : super(element) {
    _registerElements({
      "ProcessDescription":
          (e) => descriptions.add(new OgcProcessDescription_16(e))
    });
...
class OgcProcessOutputs_34 extends OgcDocument {
  List<OgcOutputDescription_35> outputData =
      new List<OgcOutputDescription_35>();
...
class OgcLiteralOutput_37 extends OgcDocument {
  ...
  OgcLiteralOutput_37(Xml.XmlElement element) : super(element) {
    _registerElements(
        {"DataType": (e) => datatype = e.text, "UOMs": _errorElement,});
  }
...
class OgcDataInputs_40 extends OgcDocument {
  ...
  OgcDataInputs_40(Xml.XmlElement element) : super(element) {
    _registerElements({"Input": (e) => inputType = new OgcInputType_41(e)});
...
class OgcLiteralData_48 extends OgcDocument {
  ...
  OgcLiteralData_48(Xml.XmlElement element) : super(element) {
    _registerAttributes({"datatype": _errorAttribute, "uom": _errorAttribute,});
...
class OgcExecuteResponseDocument_54 extends OgcDocument {
  ...
  OgcStatus_55 status;
  List<OgcOutputDefinitions_58> outputDefintions =
      new List<OgcOutputDefinitions_58>();
  ...
  OgcExecuteResponseDocument_54(Xml.XmlElement element) : super(element) {
    _registerElements({
      ...
      "OutputDefinitions":
          (e) => outputDefintions.add(new OgcOutputDefinitions_58(e)),
...
class OgcStatus_55 extends OgcDocument {
  ...
  OgcStatus_55(Xml.XmlElement element) : super(element) {
    _registerElements({
      ...
      "ProcessStarted":
          (e) => processStarted = e.text, // TODO: percent completed
    ...
    _registerAttributes({"creationTime": (attr) => creationTime = attr.value,});
  }
  ...
  static bool isComplete(OgcStatusCodes code) => (code == OgcStatusCodes.succeeded ||
      code == OgcStatusCodes.failed ||
      code == OgcStatusCodes.timeout ||
      code == OgcStatusCodes.systemFailure);

  static bool isActive(OgcStatusCodes code) => (code == OgcStatusCodes.notYetSubmitted ||
      code == OgcStatusCodes.accepted ||
      code == OgcStatusCodes.started ||
      code == OgcStatusCodes.paused);

  static bool isFailure(OgcStatusCodes code) => (code == OgcStatusCodes.failed ||
      code == OgcStatusCodes.timeout ||
      code == OgcStatusCodes.systemFailure);
...
class OgcProcessFailed_57 extends OgcDocument {
  ...
  OgcProcessFailed_57(Xml.XmlElement element) : super(element) {
    _registerElements({
      "ExceptionReport":
          (e) => exceptionReport = new OgcExceptionReportDocument(e)
    });
...
class OgcOutputDefinitions_58 extends OgcDocument {
  ...
  OgcOutputDefinitions_58(Xml.XmlElement element) : super(element) {
    _registerElements({"Output": (e) => output = new OgcOutput_51(e)});
...
class Ogc_Exception extends OgcDocument {
  ...
  Ogc_Exception(Xml.XmlElement element) : super(element) {
    _registerElements({"ExceptionText": (e) => text = e.text});
  }
